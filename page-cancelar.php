...
?>
    ...
    <main id="main">
        ...
        <section class="container-fluid p-0" data-aos="fade-up">
            ...
            $banner_cancelar = get_theme_mod( 'set_banner_cancelar_mei', 'abrir-cancelar-banner');
            $args_cancelar = array(
                'post_type'			=> 'page',
                'posts_per_page'	=> 1,
                'name'              => $banner_cancelar
            );

            $banner_cancelar_loop = new WP_Query( $args_cancelar );

            if( $banner_cancelar_loop->have_posts() ):
                while( $banner_cancelar_loop->have_posts() ): 
                    $banner_cancelar_loop->the_post();
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="card bg-transparent border-0 my-2 w-100">
                            <div class="card-body float-left">
                                <p class="card-title color-969696 font-weight-bold text-uppercase title-change">Evite pendências com seu CNPJ</p>
                                <p class="card-title text-change">
                                    <strong>Cancele seu CNPJ MEI</strong>
                                    <strong>sem custo.</strong> Você evita
                                    complicações e dívidas.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="card border-0 my-2 one-time-fee">
                            <div class="card-body text-center">
                                ...
                                <div class="d-flex">
                                    <a href="<?php echo $id_product_cancel; ?>" class="btn btn-altere-agr hvr-wobble-horizontal">Cancele Agora!</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row mb-5">
                    <div class="col text-center">
                        <h2 class="color-5AA1DD text-uppercase">O que devo saber sobre o <strong>cancelamento?</strong> </h2>
                    </div>
                </div>
                ...
                <div class="card-columns d-none d-lg-block">
                    ...
                    $destaque_args = array(
                        'post_type'			=> 'post',
                        'posts_per_page'	=> 3,
                        'category_name'     => 'destaque cancelar mei',
                        'orderby'           =>'post__in'
                    );
                    ...
                    <div class="owl-item">
                        <div class="card bg-transparent border-0 m-auto text-left">
        ...
        <section class="mb-5" data-aos="fade-up">
                <div class="container" data-aos="fade-up" >
                    <form action="<?php echo wc_get_checkout_url(); ?>" id="cancel-mei-form" class="col-open-mei-form p-3" method="POST">
                        ...
                        <div class="form-row d-flex justify-content-start align-items-center">
                            ...
                            <div class="col-sm-12 col-lg-3 my-2 text-center">
                                <button class="btn btn-open-mei-form text-uppercase w-100" name="cancel-mei-form" type="submit">Cancelar</button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="card bg-transparent border-0 my-2 bg-EDEDED w-100 card-start">
                            ...
                            <div class="card-body text-center order-12 py-0">
                                <button class="btn btn-veja-mais">veja mais</button>
                            </div>
