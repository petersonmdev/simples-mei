...
<main id="main">
    ...
    <section class="mb-5" data-aos="fade-up" date-aos-delay="200">
        <?php  
    ...
    <section class="container-fluid first-container direction-form p-0" data-aos="fade-up" date-aos-delay="200">

        <div class="container d-flex">
            <div class="row no-gutters d-flex align-items-center justify-content-between w-100">
                <div class="col-xs-12 col-lg-4 d-flex align-items-center justify-content-center my-3" data-aos="zoom-in" data-aos-delay="400">
                    <div class="card-body-r card border-0 bg-FF9716 card-start" style="height: 250px;">
                        <div class="card-body card-body-start">
                            ...
                            <?php
                                $id_product = get_theme_mod('set_id_product');
                                $add_to_cart = '?add-to-cart=' . $id_product;
                            ?>
                            <a class="btn btn-open-now" id="open-form" href="<?php echo $add_to_cart ?>">abrir agora</a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-lg-4 d-flex align-items-center justify-content-center my-3" data-aos="zoom-in" data-aos-delay="400">
                    <div class="card-body-r card border-0 bg-5AA1DD card-start" style="height: 250px;">
                        <div class="card-body card-body-start">
                            ...
                            <button class="btn btn-change-mei"><span class="text-uppercase color-1773A7">quero
                                    alterar</span></button>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-lg-4 d-flex align-items-center justify-content-center my-3" data-aos="zoom-in" data-aos-delay="400">
                    <div class="card-body-r card border-0 bg-5AA1DD card-start" style="height: 250px;">
                        <div class="card-body card-body-start">
                            ...
                            <button class="btn btn-news"><span class="text-uppercase color-1773A7">saiba
                                    mais</span></button>
                        </div>
                    </div>
                </div>
    ...
    <section class="mb-5" data-aos="fade-up" date-aos-delay="200">
        ...
        <div class="container-fluid container-pattern-form d-flex align-items-center">
            <div class="container-pattern-form-bg"></div>
            <div class="container" data-aos="fade-up" >
                <form class="col-open-mei-form p-3" method="POST">
                    ...
                    <div class="form-row d-flex justify-content-start align-items-center">
                        <div class="col-sm-12 col-lg-3 my-2">
                            <input type="text" name="billing_first_name" id="" class="form-control input-open" placeholder="nome"
                                aria-describedby="helpId">
                        </div>
                        <div class="col-sm-12 col-lg-3 my-2">
                            <input type="email" class="form-control input-open email-open-form" name="" id=""
                                aria-describedby="emailHelpId" placeholder="E-MAIL">
                        </div>
                        <div class="col-sm-12 col-lg-3 my-2">
                            <input type="text" name="" id="" class="form-control input-open" placeholder="CPF"
                                aria-describedby="helpId">
                        </div>
                        <div class="col-sm-12 col-lg-3 my-2 text-center">
                            <a type="submit" class="btn btn-open-mei-form text-uppercase w-100" href="?add-to-cart=176">abrir</a>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <section class="mb-5" data-aos="fade-up" date-aos-delay="200">
        ...
        <div class="container-fluid container-connected">
